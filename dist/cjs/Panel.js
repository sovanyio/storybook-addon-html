...
var _html = _interopRequireDefault(require("prettier/plugins/html"));
...
var Panel = exports.Panel = function Panel(props) {
  ...
  var _useState = (0, _react.useState)(),
    ...
    formattedCode = _useState2[0],
    setFormattedCode = _useState2[1];
  (0, _managerApi.useChannel)(_defineProperty({}, _constants.EVENTS.CODE_UPDATE, function (_ref) {
    var code = _ref.code;
  ...
  var parameters = (0, _managerApi.useParameter)(_constants.PARAM_KEY, {});
  ...
  (0, _react.useEffect)(function () {
    ...
    function _formatCode() {
      _formatCode = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.t0 = setFormattedCode;
              _context.next = 4;
              return (0, _standalone.format)(code, prettierConfig);
            case 4:
